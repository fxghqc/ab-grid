...
(function (ag) {
    ...
    (function (grid) {
        ...
        var RenderedCell = (function () {
            ...
            RenderedCell.prototype.editCell = function (element, select, key) {
            ...
            RenderedCell.prototype.setupEditorEvent = function (element) {
                ...
                element.addEventListener('keydown', function (event) {
                    var key = event.which || event.keyCode;
                    if (key === grid.Constants.KEY_ESCAPE) {
                        _this.stopEditing(element, blurListener, true);
            ...
            RenderedCell.prototype.startEditing = function (key) {
                ...
                if (typeof cellEditor === 'function') {
                    this.editCell(cellEditor(), false, key);
                }
                else {
                    this.editCell(this.defaultEditor(), true, key);
                }
            };
